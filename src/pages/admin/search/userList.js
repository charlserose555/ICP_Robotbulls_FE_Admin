        ...
        <div className="flex h-full flex-col container justify-center items-center">
            <div className="flex flex-col justify-start items-center w-full h-full p-6 rounded-2 bg-white">
                <div className="flex flex-col md:flex-row w-full justify-between gap-1">
                    <span className="text-gray-800 col-span-8 flex items-start justify-start text-[20px] font-medium px-1">Investor User List</span>
                ...
                <div className="rounded-2 bg-gray-60 w-full mt-5" style={{border: '1px solid #f4f5f7'}}>
                    <div className="flex flex-col lg:flex-row justify-between items-center gap-2">
                        <div className="flex flex-row gap-4 py-6 px-4 justify-center items-center w-full flex-wrap md:flex-nowrap whitespace-nowrap">
                            <p className="text-gray-500 text-[14px] font-medium cursor-pointer">Investor / Users</p>
                            <p className="text-gray-500 text-[14px] font-medium cursor-pointer">Admin Account</p>

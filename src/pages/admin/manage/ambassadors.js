      ...
      <div className="flex h-full flex-col container justify-center items-center">
        <div className="flex flex-col justify-start items-center w-full h-full p-6 rounded-2 bg-white">
            <div className="flex flex-row w-full justify-between">
                ...
                <a className="text-14 w-34 px-2 mx-2 py-2 fill-btn-continue text-white font-medium bg-darkblue-550 rounded-2 flex flex-row flex-wrap justify-around gap-45 items-center"
                    style={{textAlign: 'center', cursor: 'pointer'}}
                    onClick={() => { dispatch(ShowModal("addBonus"))}}>
                    <AddFundsIcon/>
                    <p className='text-white font-medium text-14 hidden md:block'>Add Bonuses</p>
                </a>
            </div>

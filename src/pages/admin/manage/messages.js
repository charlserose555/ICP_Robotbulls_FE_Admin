            ...
            <div className="rounded-2 bg-gray-60 w-full mt-5" style={{border: '1px solid #f4f5f7'}}>
                <div className="flex flex-col lg:flex-row justify-between items-center gap-2">
                    <div className="flex flex-row gap-4 py-6 px-4 justify-center items-center w-full flex-wrap md:flex-nowrap whitespace-nowrap">
                        <p className="text-gray-500 text-[14px] font-medium cursor-pointer whitespace-nowrap">Investor/Users</p>
                        <p className="text-gray-500 text-[14px] font-medium cursor-pointer whitespace-nowrap">Admin Account</p>
                        <p className="text-gray-500 text-[14px] font-medium cursor-pointer whitespace-nowrap">All</p>
                        <p className="text-gray-500 text-[14px] font-medium cursor-pointer whitespace-nowrap">Biggest</p>
                    </div>
